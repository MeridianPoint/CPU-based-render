...
public:
	...
	/*T& r() { return m_vec[0]; }
	T r() const { return m_vec[0]; }*/
	T& ctheta() { return m_vec[1]; }
	T ctheta() const { return m_vec[1]; }
	T& h() { return m_vec[2]; }
	T h() const { return m_vec[2]; }
	
	//spherical coordinate
	T& rho() { return m_vec[0]; }
	T rho() const { return m_vec[0]; }
	T& phi() { return m_vec[1]; }
	T phi() const { return m_vec[1]; }
	T& stheta() { return m_vec[2]; }
	T stheta() const { return m_vec[2]; }
